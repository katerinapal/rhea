...
function from_arraybuffer(data) {
    if (data instanceof ArrayBuffer) return new Buffer(new Uint8Array(data));else return new Buffer(data);
}
...
function wrap(ws) {
    ...
    return {
        ...
        get_id_string: function get_id_string() {
            return ws.url;
        }
    };
}

exports.wsjs = mod_wsjs = {

    'connect': function connect(Impl) {
        return function (url, protocols, options) {
            return function () {
                return {
                    connect: function connect(port_ignore, host_ignore, options_ignore, callback) {
